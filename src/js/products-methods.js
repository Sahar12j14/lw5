...
export function setNameProduct(product, nameProduct) {
  if (
    ...
    !isNaN(parseFloat(nameProduct)) || 
    isFinite(nameProduct) ||
...
export function setPriceForOneProduct(product, priceForOneProduct) {
  if (
    isNaN(parseFloat(priceForOneProduct)) || 
    !isFinite(priceForOneProduct) ||
    typeof product !== 'object' ||
...
export function setCountProduct(product, countProduct) {
  if (
    isNaN(parseFloat(countProduct)) || 
    !isFinite(countProduct) ||
    typeof product !== 'object' ||
    countProduct === null ||
